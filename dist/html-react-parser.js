(function (global, factory) {
	...
	attributesToProps$1.attributesToProps = void 0;
	...
	attributesToProps$1.attributesToProps = attributesToProps;
	/**
	...
	domToReact$1.domToReact = void 0;
	var react_1 = require$$0;
	var attributes_to_props_1 = attributesToProps$1;
	...
	function domToReact(nodes, options) {
	    ...
	    for (var index = 0; index < nodesLength; index++) {
	        ...
	        if (skipAttributesToProps(element)) {
	            ...
	            props = (0, attributes_to_props_1.attributesToProps)(element.attribs, element.name);
	        }
	        var children = void 0;
	        switch (node.type) {
	            case 'script':
	...
	domToReact$1.domToReact = domToReact;
	/**
	...
	var dom_to_react_1 = domToReact$1;
	...
	(function (exports) {
		...
		var html_to_dom_1 = __importDefault(htmlToDom);
		__exportStar(attributesToProps$1, exports);
		__exportStar(domToReact$1, exports);
		var domhandler_1 = lib$5;
