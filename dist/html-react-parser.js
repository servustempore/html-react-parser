(function (global, factory) {
	...
	utilities$3.formatDOM = utilities$3.formatAttributes = void 0;
	var domhandler_1$5 = lib$6;
	...
	utilities$3.formatAttributes = formatAttributes$1;
	/**
	...
	function formatDOM(nodes, parent, directive) {
	    ...
	    for (; index < nodesLength; index++) {
	        ...
	        switch (node.nodeType) {
	            case 1: {
	                ...
	                // script, style, or tag
	                current = new domhandler_1$5.Element(tagName, formatAttributes$1(node.attributes));
	            ...
	            case 3:
	                current = new domhandler_1$5.Text(node.nodeValue);
	                break;
	            case 8:
	                current = new domhandler_1$5.Comment(node.nodeValue);
	                break;
	            default:
	                continue;
	        }
	    ...
	    if (directive) {
	        current = new domhandler_1$5.ProcessingInstruction(directive.substring(0, directive.indexOf(' ')).toLowerCase(), directive);
	...
	utilities$3.formatDOM = formatDOM;

	var __importDefault$6 = (commonjsGlobal && commonjsGlobal.__importDefault) || function (mod) {
	    return (mod && mod.__esModule) ? mod : { "default": mod };
	};
	Object.defineProperty(htmlToDom$1, "__esModule", { value: true });
	var domparser_1 = __importDefault$6(domparser$1);
	var utilities_1$4 = utilities$3;
	...
	function HTMLDOMParser$1(html) {
	    ...
	    return (0, utilities_1$4.formatDOM)((0, domparser_1.default)(html), null, directive);
	}
	htmlToDom$1.default = HTMLDOMParser$1;
	...
	lib$4.BOOLEAN = BOOLEAN;
	lib$4.BOOLEANISH_STRING = BOOLEANISH_STRING;
	lib$4.NUMERIC = NUMERIC;
	lib$4.OVERLOADED_BOOLEAN = OVERLOADED_BOOLEAN;
	lib$4.POSITIVE_NUMERIC = POSITIVE_NUMERIC;
	lib$4.RESERVED = RESERVED;
	lib$4.STRING = STRING;
	lib$4.getPropertyInfo = getPropertyInfo;
	lib$4.isCustomAttribute = isCustomAttribute;
	lib$4.possibleStandardNames = possibleStandardNames;
	...
	var inline_style_parser_1 = __importDefault$5(inlineStyleParser);
	/**
	...
	var style_to_object_1 = __importDefault$4(cjs);
	var utilities_1$3 = utilities$1;
	/**
	...
	function StyleToJS(style, options) {
	    ...
	    (0, style_to_object_1.default)(style, function (property, value) {
	        // skip CSS comment
	        if (property && value) {
	            output[(0, utilities_1$3.camelCase)(property, options)] = value;
	        }
	    });
	    return output;
	}
	...
	var react_property_1 = lib$4;
	var utilities_1$2 = utilities$2;
	...
	function attributesToProps(attributes, nodeName) {
	    ...
	    for (var attributeName in attributes) {
	        ...
	        if (utilities_1$2.PRESERVE_CUSTOM_ATTRIBUTES) {
	            props[attributeName] = attributeValue;
	        }
	    }
	    // transform inline style to object
	    (0, utilities_1$2.setStyleProp)(attributes.style, props);
	    return props;
	}
	...
	var react_1 = require$$0;
	var attributes_to_props_1 = __importDefault$3(attributesToProps$1);
	var utilities_1$1 = utilities$2;
	var React = {
	...
	function domToReact(nodes, options) {
	    ...
	    var transform = options.transform || utilities_1$1.returnFirstArg;
	    ...
	    for (var index = 0; index < nodesLength; index++) {
	        ...
	        if (node.type === 'text') {
	            ...
	            if (isWhitespace &&
	                node.parent &&
	                !(0, utilities_1$1.canTextBeChildOfNode)(node.parent)) {
	                continue;
	            }
	        ...
	        if (skipAttributesToProps(element)) {
	            (0, utilities_1$1.setStyleProp)(element.attribs.style, element.attribs);
	...
	function skipAttributesToProps(node) {
	    return (utilities_1$1.PRESERVE_CUSTOM_ATTRIBUTES &&
	        node.type === 'tag' &&
	        (0, utilities_1$1.isCustomComponent)(node.name, node.attribs));
	}
	...
	var encode_html_js_1 = __importDefault$2(encodeHtml);
	...
	(function (exports) {
		 ...
		 */
		exports.ElementType = __importStar(lib$5);
	...
	utilities.unsetRootParent = void 0;
	/**
	...
	utilities.unsetRootParent = unsetRootParent;
	...
	parse$1.HTMLReactParser = void 0;
	var html_to_dom_1 = __importDefault(htmlToDom);
	...
	(function (exports) {
		...
		var html_dom_parser_1 = __importDefault(htmlToDom$1);
